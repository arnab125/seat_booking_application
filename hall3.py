...
class Hall(Star_Cinema):
    ...
    def book_seats(self, person_name, phone_no, id_show,seat_no):
           ...
           # print(self.seats)
            ...
            if (id_show == a[0][0]):
                if (seat_no == "A0"):
                    self.seats["ay0"][0][0] = "X"
                if (seat_no == "A1"):
                    self.seats["ay0"][0][1] = "X"
                if (seat_no == "A2"):
                    self.seats["ay0"][0][2] = "X"
                if (seat_no == "B0"):
                    self.seats["ay0"][1][0] = "X"
                if (seat_no == "B1"):
                    self.seats["ay0"][1][1] = "X"
                if (seat_no == "B2"):
                    self.seats["ay0"][1][2] = "X"
                return (self.seats["ay0"])
            elif (id_show == a[1][0]):
                if (seat_no == "A0"):
                    self.seats["sk0"][0][0] = "X"
                if (seat_no == "A1"):
                    self.seats["sk0"][0][1] = "X"
                if (seat_no == "A2"):
                    self.seats["sk0"][0][2] = "X"
                if (seat_no == "B0"):
                    self.seats["sk0"][1][0] = "X"
                if (seat_no == "B1"):
                    self.seats["sk0"][1][1] = "X"
                if (seat_no == "B2"):
                    self.seats["sk0"][1][2] = "X"
                return (self.seats["sk0"])
            #return self.seats
    ...
    def view_available_seats(self,id):
        a = self.entry_show()
        seats=self.book_seats(1,2,id,4)
        # print(a)
        if (id == a[0][0]):
            for i in range(3):
                print(seats[0][i],end="       ")
...
for j in range(4):
    ...
    if(a=="1"):
        ...
        print("Hall : A10")
        print("------------------------------------------------------------------------------")
        a=Hall(1,1,3).book_seats(customer_name,phone_no,show_id,seat_no)
        #s = Hall(1, 1, 3).view_available_seats(show_id)
        print(a)
        #print(s)